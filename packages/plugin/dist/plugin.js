...
class GryphonSettingTab extends PluginSettingTab {
    ...
    hide() {
        ...
        try {
            ...
            if (msg)
                window.setTimeout(() => new Notice(msg, 10000), 0);
        }
        catch { /* best-effort */ }
    }
...
class GryphonPlugin extends Plugin {
    ...
    async ensureIpcListening(timeoutMs = 2000) {
        ...
        try {
            await Promise.race([
                ...
                new Promise((_, reject) => window.setTimeout(() => reject(new Error("ipc-recovery-timeout")), timeoutMs)),
            ]);
    ...
    _dropStalePerReloadSessionIds() {
        ...
        if (sid.startsWith("codex-cli-") || sid.startsWith("gemini-cli-") ||
            ...
            if (this.settings && this.settings.devCliDebug)

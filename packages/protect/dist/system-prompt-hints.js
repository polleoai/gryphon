 ...
 * stays usable as-is.
 */
const GRYPHON_SYSTEM_PROMPT_HINT = "IMPORTANT — you are running inside the Gryphon Obsidian plugin. " +
...
const GRYPHON_FALLBACK_DENY_HINT = "· Additional guidance for THIS session: tool refusals in this " +
 ...
 */
const GRYPHON_SDK_COMPOUND_REQUEST_RULE = " · CRITICAL — COMPOUND REQUESTS WITH POTENTIALLY-RESTRICTED " +

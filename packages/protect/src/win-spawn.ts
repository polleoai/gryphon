 ...
 */
function isWindowsShim(commandPath: unknown): boolean {
 ...
 */
function _collapseNewlines(arg: unknown): string {
 ...
 */
function wrapForCmdShim(commandPath: string, args: string[]): { command: string; args: string[]; options: { windowsVerbatimArguments: boolean } } {

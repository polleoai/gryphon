...
const GRYPHON_GEMINI_SYSTEM_PROMPT = GRYPHON_GEMINI_SYSTEM_PROMPT_BASE + GRYPHON_SDK_COMPOUND_REQUEST_RULE;
            ...
            const hadProtectedDeny = turnSlice.some((m) => {
                ...
                return m.parts.some((p) => {
                    ...
                    if (typeof resp === "string")
                        return resp.includes(_GRYPHON_DENY_MARKER);
...
function _extractFinalText(finalMessage) {
    if (!finalMessage || !Array.isArray(finalMessage.parts))
        return "";

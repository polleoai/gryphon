...
const factory = require("../src/providers/factory");
...
test("F20 fix — DEFAULT_PROVIDER_PREFERENCE is exported and equals 'auto'", () => {
  const { DEFAULT_PROVIDER_PREFERENCE } = require("../src/constants");
...
const { modelButtonText, modelButtonTitle } = require("../src/chat-view");
...
test("F23-1 — cross-provider switch: toolbar label, dropdown selection, and resolveModel agree on the same OpenAI model", () => {
  ...
  } = require("../src/providers/openai-api/pricing");
